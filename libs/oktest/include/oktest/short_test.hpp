...
#define CONSTEXPR_REQUIRE(...) OKL_REQUIRE(__VA_ARGS__)
#define CONSTEXPR_REQUIRE_NOT(...) OKL_REQUIRE_NOT(__VA_ARGS__)
#define CONSTEXPR_REQUIRE_THROWS(...) OKL_REQUIRE_THROWS(__VA_ARGS__)
#define CONSTEXPR_REQUIRE_THROWS_AS(exception, ...) OKL_REQUIRE_THROWS_AS(exception, __VA_ARGS__)
#define CONSTEXPR_REQUIRE_NOTHROW(...) OKL_REQUIRE_NOTHROW(__VA_ARGS__)

#define CONSTEVAL_REQUIRE(...) OKL_REQUIRE(__VA_ARGS__)
#define CONSTEVAL_REQUIRE_NOT(...) OKL_REQUIRE_NOT(__VA_ARGS__)
#define CONSTEVAL_REQUIRE_THROWS(...) OKL_REQUIRE_THROWS(__VA_ARGS__)
#define CONSTEVAL_REQUIRE_THROWS_AS(exception, ...) OKL_REQUIRE_THROWS_AS(exception, __VA_ARGS__)
#define CONSTEVAL_REQUIRE_NOTHROW(...) OKL_REQUIRE_NOTHROW(__VA_ARGS__)
