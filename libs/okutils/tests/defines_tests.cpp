...
CONSTEXPR_TEST_CASE("attributes")
{
	OKL_ASSUME(true);
...
CONSTEXPR_TEST_CASE("pure_functions")
{
...
CONSTEXPR_TEST_CASE("inline_macros")
{
...
OKL_WARNING_POP()
TEST_CASE("warning_macros") { REQUIRE(warning_test(0)); };
