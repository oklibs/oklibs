...
- **[okbase](libs/okbase)**: Foundational defines, compiler/platform abstractions, primitive type aliases, and concepts.
...
- **[okutils](libs/okutils)**: A collection of common utility functions.
